...
Ce code utilise le IDE d'Arduino et le lien de téléchargement de cette application est dans les fichiers.

Pour bien utiliser le code, il faut l'installation de plusieurs librairies sur le IDE.
